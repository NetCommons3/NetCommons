<?php
/**
 * Add translation stuff to frames
 *
 ...
 */
class AddTranslationStuffToFrames extends CakeMigration {
 ...
 * @var string
 */
	public $description = 'add_translation_stuff_to_frames';
 ...
 */
	public $migration = array(
		...
		'down' => array(
			'drop_field' => array(
				'frames' => array('translation_engine', 'is_auto_translated', 'is_first_auto_translation'),
			),
		),
	);
