 ...
 */
	public function testSetBoxOnRoomFailure() {
		...
		$query = array(
			'recursive' => 0,
			'fields' => [
				$this->CurrentFrame->Box->alias . '.id',
				$this->CurrentFrame->Box->alias . '.container_id',
				$this->CurrentFrame->Box->alias . '.type',
				$this->CurrentFrame->Box->alias . '.space_id',
				$this->CurrentFrame->Box->alias . '.room_id',
				$this->CurrentFrame->Box->alias . '.page_id',
				$this->CurrentFrame->Box->alias . '.container_type',
				$this->CurrentFrame->Box->alias . '.weight',
				'Room.id',
				'Room.space_id',
				'Room.page_id_top',
				'Room.parent_id',
				...
				'Space.type',
				'Space.plugin_key',
				'Space.default_setting_action',
				'Space.room_disk_size',
				'Space.room_id_root',
				'Space.page_id_top',
				'Space.permalink',
				'Space.is_m17n',
				'Space.after_user_save_model',
			],
			'conditions' => array(
				'Box.id' => '1',
			),
