<?php
/**
 * NetCommonsTreeBehavior::moveDown()のテスト
 *
 ...
 */
class NetCommonsTreeBehaviorMoveDownTest extends NetCommonsTreeBehaviorCase {

/**
 * moveDown()テストのDataProvider
 *
 * ### 戻り値
 *  - id 移動するレコードのID
 *  - number ノードを移動する場所の数、または最後の位置に移動する場合はtrue
 *  - parentId 親ID
 *  - expected 期待値
 *
 * @return array データ
 ...
 */
	public function dataProvider() {
		...
		$result[3]['id'] = '1';
		$result[3]['number'] = 5;
		$result[3]['parentId'] = [null, '1', '2', '3', '877', '878', '879', '1658', '1659', '1660'];
		$result[3]['expected'] = [
			877 => '877',
			878 => '_878',
			879 => '__879',
 ...
 */
	public function testMoveDown($id, $number, $parentId, $expected) {
		...
		$this->_debugStart();
		$result = $this->TestModel->moveDown($id, $number);
